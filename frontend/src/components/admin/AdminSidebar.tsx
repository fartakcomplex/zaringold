...
import {LayoutDashboard, Users, ShieldCheck, Ticket, MessageCircle, ArrowUpDown, Banknote, TrendingUp, FileText, FileEdit, Settings, LogOut, ChevronLeft, Moon, Sun, ShieldAlert, Shield, Store, MessageSquare, Database, Package, Layers, Mail, Bot, ShieldHalf, Umbrella, Smartphone, Car} from 'lucide-react';
