...
import {FileText, Plus, Edit, Trash2, Eye, Calendar, Clock, BarChart3, Search, Star, StarOff, ArrowLeft, X, Save, Tag, FolderOpen, Newspaper, Check, Copy, BookOpen} from 'lucide-react';
