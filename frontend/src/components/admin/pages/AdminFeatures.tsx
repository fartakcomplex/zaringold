...
import {type LucideIcon, Brain, PiggyBank, Coins, Target, Gift, UsersRound, MessageSquare, TrendingUp, Bot, Crown, Percent, GraduationCap, Repeat, Video, MapPin, Send, AlertTriangle, Settings, Save, Loader2, Sparkles} from 'lucide-react';
