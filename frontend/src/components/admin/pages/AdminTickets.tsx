...
import {Ticket, MessageCircle, Clock, CheckCircle, XCircle, AlertTriangle, Search, Send, User, Filter, Shield, Star, ChevronLeft, ChevronRight, Trash2, Lock, Phone, Mail, StickyNote, FileText, X, AlarmClock, Eye} from 'lucide-react';
