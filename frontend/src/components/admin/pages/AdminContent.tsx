...
import {MessageSquare, GraduationCap, Search, Plus, Pencil, Trash2, Loader2, EyeOff, Eye, Play, FileText, Crown, Clock, ChevronLeft, ChevronRight, Filter, BookOpen} from 'lucide-react';
