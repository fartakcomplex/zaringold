...
import {Play, FileText, Heart, Clock, Eye, Search, GraduationCap, TrendingUp, Landmark, ShoppingCart, ShieldAlert, Star, Trophy, Flame, ChevronLeft, ChevronRight, CheckCircle2, Lock, X, BookOpen, BarChart3, Zap, Award, Filter, Sparkles, Crown, Target, Calendar, Bookmark} from 'lucide-react';
