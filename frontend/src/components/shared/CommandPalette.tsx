...
import {useCommandPalette, CommandPaletteContextProvider, type CommandAction} from '@/hooks/useCommandPalette';
import {Search, TrendingUp, TrendingDown, Activity, BarChart3, ArrowDownToLine, ArrowUpFromLine, Send, Wallet, Landmark, CreditCard, PiggyBank, Crown, User, Settings, Bell, MessageCircle, Clock, type LucideIcon} from 'lucide-react';
