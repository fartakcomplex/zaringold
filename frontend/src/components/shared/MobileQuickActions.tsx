...
import {Wallet, Coins, TrendingUp, TrendingDown, ArrowLeftRight, ArrowDownToLine, ArrowUpFromLine, Gift, Send, CreditCard, Bell, Settings, User, Lock, Receipt, BarChart3, Target, Trophy, Crown, CalendarCheck, Shield, Vault, Flame, Eye, Filter, Download, QrCode, FileText, Store, RefreshCw, MessageCircle, AlertTriangle, Percent, BookOpen, Search, Plus, History, ChevronUp, Phone, CheckCircle, Star, Heart, KeyRound, Code2, Trash2} from 'lucide-react';
