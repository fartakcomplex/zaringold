...
import {Bell, BellOff, TrendingUp, TrendingDown, Plus, Trash2, CheckCheck, X, ArrowUpRight, ShoppingCart, ShieldCheck, Settings2, Star, AlertTriangle, CircleAlert} from 'lucide-react';
