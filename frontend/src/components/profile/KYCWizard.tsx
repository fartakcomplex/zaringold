...
import {Shield, CheckCircle, XCircle, Upload, Camera, Video, RotateCcw, Trash2, Info, Lock, Eye, Sparkles, IdCard, UserCheck, ShieldCheck, ScanFace, X, ChevronLeft, ChevronRight, AlertCircle, CircleDot} from 'lucide-react';
