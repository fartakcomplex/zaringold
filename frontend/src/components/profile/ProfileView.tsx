...
import {User, Mail, Phone, Shield, ShieldCheck, Wallet, Gem, Copy, Share2, Gift, Trophy, Lock, Eye, EyeOff, Check, Edit, Camera, MapPin, Calendar, Key, Clock, LogOut, Crown, Link, Smartphone, Monitor, CircleDot, AlertTriangle, ChevronDown, MessageCircle} from 'lucide-react';
