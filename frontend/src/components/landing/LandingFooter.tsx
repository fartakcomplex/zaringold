...
import {Camera, MessageSquare, Send, Phone, Mail, MapPin, ArrowLeft, ArrowRight, Heart, Shield, Sparkles} from 'lucide-react';
...
export default function LandingFooter({ onNavigate }: LandingFooterProps) {
  ...
  const socials = [
    { icon: Camera, href: '#', label: t('footer.instagram'), color: 'from-pink-500 via-rose-500 to-amber-500' },
    { icon: MessageSquare, href: '#', label: t('footer.twitter'), color: 'from-sky-400 via-blue-500 to-indigo-500' },
