...
import {Brain, TrendingUp, TrendingDown, Minus, Activity, RefreshCw, Clock, Sparkles, AlertCircle, ArrowUp, ArrowDown, ArrowUpDown, Newspaper, BarChart3, Loader2, ChevronUp, ChevronDown, ShieldAlert, Zap, Info, Globe} from 'lucide-react';
