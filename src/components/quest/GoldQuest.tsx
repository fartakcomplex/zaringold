...
import {
  BookOpen, Compass, Search, Calculator, Flame, Share2, UserCheck,
  GraduationCap, Trophy, Medal, Crown, Star, Lock, Gift, Zap,
  TrendingUp, Target, Calendar, Clock, Coins, Award, ChevronLeft,
  ChevronRight, CheckCircle, CircleDot, Sparkles, Gem, Shield,
  ArrowRight, Play, Eye, Filter, RefreshCw, BarChart3, Heart,
  ArrowUpRight, Users, XCircle, AlertCircle, FlameKindling,
} from 'lucide-react';
