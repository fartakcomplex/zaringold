...
import {
  Crown, Trophy, Medal, Star, Flame, TrendingUp, Eye, Clock,
  Upload, Link, Copy, CheckCircle, XCircle, AlertCircle,
  ChevronDown, ChevronLeft, Send, Gift, Users, Zap, Shield,
  Instagram, Youtube, MessageCircle, Twitter, Play,
  Award, BarChart3, Target, BookOpen, FileText, Hash,
  Sparkles, Gem, Diamond, ArrowUpRight, Heart, Share2,
  Clipboard, Lightbulb, Megaphone, Video, Camera, Mic,
  ArrowRight, ExternalLink, Wallet, Coins, User, Settings,
  CrownIcon, MapPin, Calendar, RefreshCw, Filter
} from 'lucide-react';
