...
import {
  Settings, Globe, Mail, Phone, MapPin, Shield, MessageSquare,
  Bell, Wrench, AlertTriangle, Save, RefreshCw, Server,
  Smartphone, Percent, Link2, Palette, Database, Download,
  Clock, FileText, Eye, Instagram, Send, Linkedin, Webhook,
  MailCheck, HardDrive, History, CheckCircle
} from 'lucide-react';
