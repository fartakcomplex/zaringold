...
import {
  ...
  ArrowLeft, Heart, Shield, Sparkles,
} from 'lucide-react';
...
const services: { label: string; authPage?: string; icon: string }[] = [
  { label: 'خرید طلا', authPage: 'trade', icon: '🪙' },
  { label: 'فروش طلا', authPage: 'trade', icon: '💰' },
  { label: 'پس‌انداز طلا', authPage: 'savings', icon: '🏦' },
  { label: 'تحلیل بازار', authPage: 'market', icon: '📈' },
  { label: 'پاداش دعوت', authPage: 'referral', icon: '🎁' },
];

const socials = [
  { icon: Instagram, href: '#', label: 'اینستاگرام', color: 'from-pink-500 via-rose-500 to-amber-500' },
  { icon: Twitter, href: '#', label: 'توییتر', color: 'from-sky-400 via-blue-500 to-indigo-500' },
  { icon: Send, href: '#', label: 'تلگرام', color: 'from-sky-500 via-cyan-500 to-blue-500' },
];
  ...
  return (
    <a
      ...
      className={cn(
        ...
        'border border-gold/15 bg-white/60 text-muted-foreground',
    ...
    <div className="space-y-3">
      ...
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          dir="ltr"
          className={cn(
            'w-full rounded-xl border border-gold/15 bg-white/60 px-4 py-2.5',
  ...
  return (
    <footer className="relative mt-8">
      ...
      <div className="relative h-px w-full">
        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gold/50 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-gold/20 to-transparent blur-sm" />
        {/* Center diamond */}
      ...
      >
          ...
          >
            ...
            <div className="space-y-6 lg:col-span-5">
              ...
              <p className="max-w-sm text-sm leading-7 text-muted-foreground">
                ...
                بالاترین امنیت، کمترین کارمزد و سریع‌ترین تراکنش‌ها.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                {[
                  { icon: Shield, text: 'SSL امن' },
                  { icon: Sparkles, text: 'مجوز رسمی' },
                ].map((badge, i) => (
                  <div
                    key={i}
                    className={cn(
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 text-sm text-muted-foreground">
                    ...
                    <span className="leading-6">تهران، خیابان ولیعصر، پلاک ۱۲۳</span>
                  </li>
        ...
        <div className="relative">
          {/* Separator */}
          <div className="h-px w-full bg-gradient-to-l from-transparent via-gold/20 to-transparent" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                <span>© ۱۴۰۴</span>
                <span className="gold-gradient-text font-semibold">زرین گلد</span>
